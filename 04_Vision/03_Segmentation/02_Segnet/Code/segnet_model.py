...
from segnet_model import MaxPoolingWithArgmax2D
from segnet_model import MaxUnpooling2D


def create_segnet(input_shape, n_labels, num_filters = 32, output_mode = 'softmax'):
    ...
    #conv_4
    conv_4 = Convolution2D(2*num_filters, (3, 3), padding = 'same', kernel_initializer='he_normal')(pool_3)
    ...
    conv_7 = Convolution2D(2*num_filters, (3, 3), padding = 'same', kernel_initializer='he_normal')(unpool_3)
    ...
    conv_8 = Convolution2D(n_labels, (3, 3), padding = 'same', kernel_initializer='he_normal')(unpool_4)
